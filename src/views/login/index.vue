<template>
  <div class="login-container">
    <img width="180px" class="m20" :src="require('@/assets/images/zhongshang.png')" alt="">
    <div class="content-wrapper row center-y">
      <img :src="require('@/assets/images/shadow.png')" class="login-form-shadow" />
      <div v-show="loginStatus == 1" class="login-form" >
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" auto-complete="on" label-position="left">
          ...
          <el-button :loading="loading" type="primary" size="large" style="width:100%;border-radius:25px;margin-top:40px;padding:10px 0;font-size:20px;" @click.native.prevent="handleLogin">登录</el-button>
        </el-form>
      </div>
      <div v-show="loginStatus == 2" class="login-form pt60" >
