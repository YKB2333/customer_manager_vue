    ...
    <my-table v-model="searchQuery" :searchForm="searchForm" @change="onChange">
      ...
      <div slot="before-table">
        <div class="tableTop">
          ...
          <el-button v-permission-button="'add'" type="primary" @click="add">添加行动计划</el-button>
        </div>
      </div>
      <el-table
        :data="tableData"
      ...
      <!--  <el-table-column label="附件">
        ...
        <el-table-column label="操作" width="280" fixed="right">
          <template slot-scope="scope">
            <el-button v-permission-button="'edit'" type="text" :disabled="scope.row.state == '2'" @click="edit(scope.row, scope.$index)">编辑</el-button>
            <el-button v-permission-button="'delete'" type="text" :disabled="scope.row.state == '2'" @click="del(scope.row, scope.$index)">删除</el-button>
            <el-button v-permission-button="'end'" type="text" :disabled="scope.row.state == '2'" @click="end(scope.row, scope.$index)">完结</el-button>
            <el-button v-permission-button="'projectProgress'" type="text" :disabled="scope.row.state == '2'" @click="showProject(scope.row, scope.$index)">项目进展</el-button>
          </template>
        </el-table-column>
      </el-table>
    </my-table>
