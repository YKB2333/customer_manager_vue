...
import { getCustomerGrowth, getChannelGrowth,findCustomerInfo } from "@/api/report";
import { findAll as findAllChannel } from '@/api/client'
export default {
  name: "ReportCustomerGrowth",
