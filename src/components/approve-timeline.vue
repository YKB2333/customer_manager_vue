  ...
  <el-popover placement="right" trigger="hover" @show="onHoverCheckedStatus(id)">
    <div class="pr10">
      <div class="fw600 pl8 pb8 mb10" style="border-bottom: 1px solid #dcdfe6">
        审批日志<span class="fs12 pl4 fw400" v-if="requestId">(流程ID:{{requestId}})</span>
      </div>
      <div>
          ...
          <div v-if="list && list.length>0"> 
            ...
            >
              <div class="row center-y">
                ...
                <img
                  class="w22 h6 mr8"
                  :src="require('@/assets/images/file/next.png')"
                />
                <div>{{ activity.receivedPersons }}</div>
              </div>
              <div v-if="activity.remark" class="fs12 mt6" style="color: #909399;">
                {{ activity.remark }}
              </div>
            </el-timeline-item>
          </div>
